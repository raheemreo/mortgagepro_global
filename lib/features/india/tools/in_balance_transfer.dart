...
class _INBalanceTransferState extends ConsumerState<INBalanceTransfer> {
  ...
  void _saveCalculation() async {
    final oldEmi = _calcEMI(_balance, _cRate, _tenure * 12);
    final newEmi = _calcEMI(_balance, _nRate, _tenure * 12);
    final oldTotal = oldEmi * _tenure * 12;
    final newTotal = newEmi * _tenure * 12;
    final grossSaved = oldTotal - newTotal;
    final procFee = _balance * (_feePercent / 100);
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Saving: Net Saved ${_fmt(netSaved)} · Old $_cRate% · New $_nRate%',
  ...
  Widget build(BuildContext context) {
    ...
    final n = _tenure * 12;
    final oldEmi = _calcEMI(_balance, _cRate, n);
    final newEmi = _calcEMI(_balance, _nRate, n);
    ...
    if (netSaved > 200000 && rateDrop >= 0.50) {
      ...
      verdictBadgeBg = const Color(0xFFFFFDE0).withValues(alpha: 0.2);
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  // Live calculations are updated instantly in Flutter
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
        ...
        // Redesigned Unified Verdict Card
        Container(
          ...
          child: Column(
            children: [
              ...
              ..._banks.map((b) {
                ...
                final bEmi = _calcEMI(_balance, bRate, n);
                final bTotal = bEmi * n;
                final feeCost = _balance * (bFee / 100);
