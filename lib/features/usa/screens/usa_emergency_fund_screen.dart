...
class _USAEmergencyFundScreenState extends ConsumerState<USAEmergencyFundScreen> {
  ...
  void _resetInputs() {
    setState(() {
      _housingController.text = '2200';
      _utilitiesController.text = '320';
      _foodController.text = '650';
      _transportController.text = '580';
      _healthController.text = '420';
      _debtController.text = '350';
      _otherController.text = '280';
      _currSavedController.text = '12000';
      _monthlyAddController.text = '1200';
      _targetMonths = 6;
    });
  ...
  void _saveCalculation() async {
    final housing = _val(_housingController);
    final utilities = _val(_utilitiesController);
    final food = _val(_foodController);
    final transport = _val(_transportController);
    final health = _val(_healthController);
    final debt = _val(_debtController);
    final other = _val(_otherController);
    final currSaved = _val(_currSavedController);
    final monthlyAdd = _val(_monthlyAddController);

    final totalMonthly = housing + utilities + food + transport + health + debt + other;
    final targetGoal = totalMonthly * _targetMonths;
    ...
    if (confirmed == true && mounted) {
      ...
      final calc = SavedCalc.create(
        ...
        inputs: {
          ...
          'targetMonths': _targetMonths.toDouble(),
        },
        results: {
            ...
            delegate: SliverChildListDelegate([
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '$_targetMonths-MONTH EMERGENCY FUND TARGET',
                      style: AppTextStyles.dmSans(
                        size: 9.5,
                    ...
                    Text(
                      'Based on ${CurrencyFormatter.format(totalMonthly, symbol: '\$').split('.').first}/mo expenses · $_targetMonths-month cushion',
                      style: AppTextStyles.dmSans(
                        size: 10,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Savings Progress to $_targetMonths-Month Goal',
                      style: AppTextStyles.playfair(size: 12.5, color: textCol, weight: FontWeight.w800),
                    ),
                    const SizedBox(height: 12),
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isFocused ? const Color(0xFF15803D) : _theme.getBorderColor(context),
              width: 1.5,
            ),
