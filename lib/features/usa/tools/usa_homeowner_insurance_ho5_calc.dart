...
class _USAHomeownerInsuranceHo5CalcState extends ConsumerState<USAHomeownerInsuranceHo5Calc> {
  ...
  void _saveCalculation() async {
    ...
    final confirmed = await showDialog<bool>(
      context: context,
      routeSettings: const RouteSettings(name: '/dialog/usa_homeowner_insurance_ho5_calc'),
  ...
  Widget build(BuildContext context) {
    ...
    final ho3Benchmark = (snapDwellingValue * 0.0057 * riskMult).roundToDouble();
    final diff = annualPremium - ho3Benchmark;

    // Coverages breakdown
    final covA = snapDwellingValue;
    final covB = (snapDwellingValue * 0.10).roundToDouble();
    final covC = (snapDwellingValue * 0.70).roundToDouble(); // HO-5 standard is 70% of dwelling
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'View HO-5 Premium Estimate',
                  style: AppTextStyles.playfair(size: 13, color: textColor, weight: FontWeight.bold),
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: 6),
                Text(
                  'Adjust parameters below and tap "Calculate HO-5 Premium" to estimate your rates.',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 2),
                      Text(
                        'HO-5 · ${CurrencyFormatter.compact(snapDwellingValue, symbol: r'$')} dwelling · ${riskLabels[snapRiskLevel] ?? ''}',
                        style: AppTextStyles.dmSans(
